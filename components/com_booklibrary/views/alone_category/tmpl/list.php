...
//****************************************   add my perenos
    ...
    if ($params->get('show_lendstatus') && $params->get('show_lendrequest') && $params->get('lend_save')) {
            ...
            <table  class="basictable bl_view_book_lend_request_table_lend_information_first my_table" 
                ...
                <tr>
                    ...
                    <td style="text-align:left;padding:0px;display:inline-block;width:230px;">
                        <input style="position:relative;top:10px;" class="inputbox" type="text" name="user_name" size="38" maxlength="80" value="<?php if ($my->name != '') echo $my->name ?>" />       
                    </td>
                    <td></td>
                </tr>
        ...
        <?php echo _BOOKLIBRARY_LABEL_LEND_REQUEST_EMAIL; ?>:&nbsp;
                    ...
                    <td style="text-align:left;padding:0px;display:inline-block;width:230px;">
                        <input style="position:relative;top:10px;" class="inputbox" type="text" name="user_email" size="38" maxlength="80" value="<?php if ($my->name != '') echo $my->email ?>" />
                    </td>
                    <td></td>
                </tr>
