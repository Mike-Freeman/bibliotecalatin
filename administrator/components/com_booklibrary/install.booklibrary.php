...
require_once($mosConfig_absolute_path . "/administrator/components/com_booklibrary/install.booklibrary.helper.php");
...
//******************************** begin check install VirtueMart*******************************
$db_OK=true;
//$database->setQuery("SHOW TABLES");
// $tables = $database->loadResultArray();
// if (!in_array($database->getPrefix()."virtuemart_products", $tables)==1){
//   $db_OK=FALSE;
// };
// if (!in_array($database->getPrefix()."virtuemart_vendors", $tables)==1){
//   $db_OK=FALSE;
// };
// if (!in_array($database->getPrefix()."virtuemart_categories", $tables)==1){
//   $db_OK=FALSE;
// };
// if (!in_array($database->getPrefix()."virtuemart_category_categories", $tables)==1){
//   $db_OK=FALSE;
// };
// if (!in_array($database->getPrefix()."virtuemart_shoppergroups", $tables)==1){
//   $db_OK=FALSE;
// };
// 

//******************************** end check install VirtueMart ********************************
...
//********************************   end check CURL extension   *********************************
    ...
    if ($booklibr) {
        switch ($version['version']) {
            ...
            case 2.2:
                ...
                $database->setQuery($query); // dobavit
                $database->query();
                echo $database->getErrorMsg();
		...
		('ice', 'x-conference/x-cooltalk');";
                    ...
                    $query = "UPDATE #__booklibrary_version SET version = 3.0 WHERE id = 2";
                    $database->setQuery($query);
                    $database->query();
                    break;
                }
    ...
    } elseif (isset($version['version']) and $version['version'] == 3.0) {
        ...
        <table width="100%" border="0">
            <tr>
                <td>
                    ...
                    <br/>
                    This component is published under the <a href="<?php echo $mosConfig_live_site . "/components/com_booklibrary/doc/LICENSE.txt"; ?>"
